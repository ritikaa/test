 ...
 $to =$_POST['email']."".$_POST['email2']; 
  echo  $message = '
	   ...
	   $mail = mail($to, $subject, $message, $headers);
			if($mail)
				{
          $msg = "Your Registration has been succesfully and password sent to your email!";
...
function validateCode()
{
	...
	catname=document.getElementById('email').value;
	if(catname!="")
	{
		$.post("ajaxRespose.php",{process:'checkcat',catname:catname},function(data){
		    if(data==1)
			{   
...
var catname1 = "";
	...
	catname1=document.getElementById('location').value;
	if(catname1!="")
	{
		$.post("ajaxRespose.php",{process:'checkcat1',catname1:catname1},function(data){  
		    if(data==1)
			{   
...
<body>
    <div class="main-wrap">
		...
		<td>
		<input id="spokesubtype2" name="spokesubtype"  class="inputfield" type="text">
...
<span id="resionError" style="display:none; color:#FF0000">*Please select the region!!</span>		
		...
		<span id="validadd2noteqError" style="display:none; color:#FF0000">*Address1 not equal to address2!!</span>
		...
		<span id="vpinError" style="display:none; color:#FF0000">*Please enter pincode only number!!</span>
		...
		<td>
		<input id="location" name="location" class="inputfield"  type="text" onBlur="validateCode();"/>
		...
		<span id="areaocorfError" style="display:none; color:#FF0000">*Please enter area min 2000 and max 10000!!</span>
		<span id="areaspokError" style="display:none; color:#FF0000">*Please enter area min 300 and max 700 sq fit</span>
		<span id="areaspwarehoError" style="display:none; color:#FF0000">*Please enter area min 10000 and max 25000 !!</span>
		<span id="areaspofficeError" style="display:none; color:#FF0000">*Please enter area min 3000 and max 5000 !!</span>
        </td></tr> 
        <tr><td>
		...
		<span id="vf2nameError" style="display:none; color:#FF0000">*Enter min 3 letter and aphabet characte!!</span>
		</td></tr>
		
		<tr><td>
		<label for="umname">User Middle Name <span style="color:Red">*</span></label></td><td>:</td>
		<td>
		...
		<span id="vmidd2nameError" style="display:none; color:#FF0000">*Enter min 3 letter and aphabet characte !</span>
		</td></tr>
		...
		<span id="validlastError" style="display:none; color:#FF0000">*Enter min 3 letter & aphabet characte!</span>
		</td></tr>
        <tr><td>
		<label for="mail">User Email Id <span style="color:Red">*</span></label></td><td>:</td>
		<td>
		<input id="email" name="email" size="7" type="text" onBlur="validateCode();" placeholder="abc@softgaeindia.com"/ >
		<input type="text" style="border:none;" size="16" name="email2" id="email2" value="@softageindia.com" />
		<span id="prod_name_indicator"></span>
		<span id="emailError" style="display:none; color:#FF0000">*Enter your email name!!</span>
		</td></tr>
    	<br>
		<br>
		...
		<span id="validempcError" style="display:none; color:#FF0000">*Start with S,s letter like S001 !</span>
		...
		<span id="validclientadd4Error" style="display:none; color:#FF0000">*Enter valide character!!</span>
		...
		<span id="validclitcon55Error" style="display:none; color:#FF0000">*Number start with 7,8,9 letter!</span>
		...
		<td>
		<input id="c_agr_exp" name="c_agr_exp" class="inputfield" type="text" >
		...
		<span id="validowrcon2Error" style="display:none; color:#FF0000">*Number start with 7,8,9 letter!!</span>
		...
		<td>
		<input id="r_agr_exp" name="r_agr_exp" class="inputfield" type="text" >
		...
		<td>
		<input id="o_agr_exp" name="o_agr_exp" class="inputfield" type="text">
		<span id="o_agr_expError" style="display:none; color:#FF0000">*Please enter agreement expiry date!!</span>
		<span id="o_agr_expDate1Error" style="display:none; color:#FF0000">*Your agreement expiry!!</span>
		...
		<span id="confirmError" style="display:none; color:#FF0000">*License or verify license not match !!</span>
		...
		<td>
		<input id="se_lic_exp" name="se_lic_exp" type="text" class="inputfield">
		<span id="se_lic_expError" style="display:none; color:#FF0000">*Please enter license expiry date!!</span>
		<span id="se_lic_expDate1Error" style="display:none; color:#FF0000">*Your license date is expire!</span>
		...
		<span id="tl_vlic_noError" style="display:none; color:#FF0000">*Please enter verify license number!!</span>
		<span id="tradconfirmError" style="display:none; color:#FF0000">*License or verify license not match !!</span>
		</td></tr>
		...
		<td>
		<input id="tl_lic_exp" name="tl_lic_exp" type="text"  class="inputfield">
		<span id="tl_lic_expError" style="display:none; color:#FF0000">*Please enter license expiry date!!</span>
		<span id="tl_lic_expDate1Error" style="display:none; color:#FF0000">*Your license date is expire!!</span>
